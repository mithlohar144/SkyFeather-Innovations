  ...
  <section className="py-16 bg-gray-50">
    <div className="container mx-auto px-6 grid md:grid-cols-3 gap-8 text-center">
      <div className="bg-white p-8 rounded-2xl shadow-sm">
        <h3 className="text-4xl font-bold text-agri-green mb-2">5x Faster</h3>
        <p className="text-gray-600">Manual Spray Equivalent</p>
        <p className="text-xs text-gray-400 mt-2">+400% Efficiency</p>
      </div>
